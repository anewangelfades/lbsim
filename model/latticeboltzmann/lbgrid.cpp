...
struct Scaled {
 ...
 //if (dynamic_cast<MeltingSolidificationCell*>(grid->getGrid(i, j, k)) == 0) {
...
/*void Grid::setOpenclType(int openclType, bool doublePrecision, std::list<cl_device_id> *devices) {
